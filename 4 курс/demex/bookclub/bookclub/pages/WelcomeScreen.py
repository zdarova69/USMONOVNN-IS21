...
class WelcomeScreen(QDialog):
    ...
    def __init__(self):
        ...
        self.stackedWidget.currentChanged.connect(self.hidden_logout)     
        
        
        self.pages = {
    1: {
        'zp': "select * from books",
        'table': '',
    },
    2: {
        'zp': """SELECT 
    ...
    def hide_label(self, count):
        ...
        for i in range(self.label_Layout.count()):
            item = self.label_Layout.itemAt(i)
            widget = item.widget()
