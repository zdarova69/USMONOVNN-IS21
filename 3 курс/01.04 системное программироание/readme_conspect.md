...
Планироващик процессов

планировщик - компонент ядра,который определяет следующий процесс на выполнение
вытесняющая и коперативная многозадачность. Коператив - программа сама решает когда нужно прекратить выполнение. Вытеснение решение о переключение на другой процесс
